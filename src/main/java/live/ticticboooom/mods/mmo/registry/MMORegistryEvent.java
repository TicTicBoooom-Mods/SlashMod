...
public class MMORegistryEvent {
    ...
    public void onNewRegistry(RegistryEvent.NewRegistry event) {
        ...
        MMORegistries.PLAYER_LEVEL_STAT = new RegistryBuilder<PlayerLevelStatType>().setName(new ResourceLocation(MMOMod.ID, "player_level_stat_type")).setType(PlayerLevelStatType.class).create();
    }
}
